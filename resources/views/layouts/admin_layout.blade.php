        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">MINI SIMRS</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/kunjungan/index-kunjungan" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Registrasi</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/billing/index-billing" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Billing</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/asesmen" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Asesmen Medis</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/pasien/index-pasien" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Pasien</p>
                                    </a>
                                </li>
